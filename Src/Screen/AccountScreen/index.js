...
import Icon, { Icons } from "../../constants/Index";
    ...
    <SafeAreaView style={styles.grandParent}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.profileContainer}>
          <Pressable onPress={() => navigation.navigate("EditProfileScreen")}>
            ...
            <Image source={user} resizeMode="contain" style={{height:100,width:100,borderRadius:100}} />
          </Pressable>
        ...
        >
          <Text style={{ ...FONTS.h2,color: isDarkMode? COLORS.darkBlue: colors.textColor }}>Arun</Text>
          <Text style={{ ...FONTS.h4,color: isDarkMode? COLORS.darkBlue: colors.textColor  }}>Arun@gmail.com</Text>
        </View>
      </View>
      ...
      <View style={styles.flexContainer}>
        ...
        >
          ...
          <Text style={{  color: colors.textColor,fontSize:SIZES.h3,fontWeight:"bold" }}>Account Overview</Text>
          ...
          <View Style={styles.overalprofilecontainer}>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={styles.menuIcons}>
                  ...
                  <Feather name="edit" size={24} color={ isDarkMode? COLORS.darkBlue: colors.textColor} />
                </View>
                <View>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={styles.menuIcons}>
                <Ionicons name="notifications-outline" size={24} color={ isDarkMode? COLORS.darkBlue: colors.textColor} />
                </View>
                <View>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={styles.menuIcons}>
                <Ionicons name="help" size={24} color={ isDarkMode? COLORS.darkBlue: colors.textColor} />
                </View>
                <View>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={styles.menuIcons}>
                <MaterialIcons name="privacy-tip" size={24} color={ isDarkMode? COLORS.darkBlue: colors.textColor} />
                </View>
                <View>
